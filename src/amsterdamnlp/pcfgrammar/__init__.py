...
_import_structure = {
    ...
    "tokenization_pcfg": ["PcfgTokenizer"],
}
...
try:
    ...
    _import_structure["tokenization_pcfg_fast"] = ["PcfgTokenizerFast"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .tokenization_pcfg_fast import PcfgTokenizerFast
